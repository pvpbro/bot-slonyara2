...
clicker_games = {}  # {user_id: {'level': уровень, 'mistakes': ошибки, 'correct': правильная кнопка, 'score': счет, 'start_time': время, 'streak': серия}}
    ...
    if text.startswith('рул '):
        try:
            ...
            if is_number and win_number == number_bet:
                ...
                win = True
                multiplier = 2
            elif bet_type == 'row1' and win_number in {1,4,7,10,13,16,19,22,25,28,31,34}:
                win = True
                multiplier = 3
            elif bet_type == 'row2' and win_number in {2,5,8,11,14,17,20,23,26,29,32,35}:
                win = True
                multiplier = 3
            elif bet_type == 'row3' and win_number in {3,6,9,12,15,18,21,24,27,30,33,36}:
                win = True
                multiplier = 3
